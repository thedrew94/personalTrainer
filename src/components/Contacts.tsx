...
export default function Contacts() {
  const [openContactsMap, setOpenContactsMap] = useState(false);
  ...
  return (
    <>
        ...
        <ul className="contacts_list">
          ...
          >
            <button
              ...
              type="button"
              role="button"
              aria-label="Visualizza la mappa"
              onClick={(e) => {
                e.preventDefault();
                e.stopPropagation();
                setOpenContactsMap(true);
              }}
            >
              {svgSelector({
                svgName: "map",
      ...
      {openContactsMap && <ContactsMap setOpenContactsMap={setOpenContactsMap} />}
    </>
  );
}
